...
<section class="bg-light position-relative">
    <div class="main-slider dots-style theme1" >
      <?php 
      include ("linkToDB.php");
      $select = mysqli_query($conn, "select * from slidebar");
      while($row = mysqli_fetch_assoc($select)){
        echo "<div class='slider-item ' style='background-image: url(assets/img/$row[img]); background-size:cover; '>
        
            <div class='container'>
                <div class='row align-items-center slider-height'>
                    <div class='col-12'>
                        <div class='slider-content' style='float:right; text-align:right'>
                            ...
                            <a href='$row[btnLink]'
                                ...
                                data-animation-in='zoomIn' data-delay-in='3'>تسوق الان</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            echo "<div class='col-md-6 mb-30'>
                <div class='position-relative zoom-in overflow-hidden'>
                    <div class='banner-thumb'>
                        <img src='assets/img/$row[img]' alt='banner-thumb-naile'>
                    </div>
                    <div class='banner-content' style='float:right; text-align:right; margin-left:65%' >
                        <p class='text text-capitalize text-dark mb-10'>$row[titleAR]</p>
                        <h4 class='title text-capitalize text-dark'>$row[valueAR]</h4>
                        <a class='view-link text-capitalize mt-20' href='$row[link]'><span class='ion-android-arrow-dropleft-circle theme-color'></span> عرض المجموعة
                            </a>
                    </div>
                </div>
            </div>";
...
<section class="product-tab bg-white pt-40 pb-70">
    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="section-title text-center mb-30">
                        <h2 class="title text-dark text-capitalize mb-20" id="bs">أفضل البائعين</h2>
                        <p class="text">تصفح مجموعة منتجاتنا الجديدة.</p>
                    </div>
                </div>
                <div class="col-12">
                    <nav class="product-tab-menu theme1">
                        <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="pills-contact-tab" href="#ac"
                                    role="tab" aria-selected="false">الخصومات</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" href="#ts"
                                    role="tab" aria-selected="false">افضل البائعين</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-home-tab"  href="#hc"
                                    role="tab"  aria-selected="true">افضل الفئات</a>
                            </li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="row" >
            <div class="col-12">
                <div class="tab-content" id="pills-tabContent">
                    <h2 class="title text-dark text-capitalize mb-20" style="text-align: right;">افضل الفئات</h2>
                    <!-- first tab-pane -->
                    <div class="tab-pane fade show active"  id="pills-home" role="tabpanel"
                        ...
                        <div class="product-slider-init theme1 slick-nav">
                          <?php 
                          include ("linkToDB.php");
                          $select = mysqli_query($conn, "select * from hotCat2");
                          while($row = mysqli_fetch_assoc($select)){
                            
                     ?>
                    <form id="hc" method="post" action="index.php?id=<?= $row['id'] ?>">
                     <div class='slider-item'>
                                <div class='card product-card'>
                                    <div class='card-body p-0'>
                                        <div class='media flex-column'>
                                            <div class='product-thumbnail w-100 position-relative'>
                                                <span class='badge badge-success top-left'><?= $row['offerVal']?></span>
                                                <a class='d-block'>
                                                    
                                                <!--////ProImg --><img name='img' class='first-img' style='width:360px; height:480px' src='assets/img/<?= $row['img'] ?>'
                                                        alt='thumbnail'>
                                                ...
                                                <!--////Add btn --><input type="submit" name="add_to_cart" class="btn  btn-block" value="أضافة الى السلة"> 
                                                        
                                                

                                                <button name="add_to_wish"><li><a>
                                                                <span data-toggle='tooltip' data-placement='bottom'
                                                                    title='أضافة الى المفضلة'
                                            ...
                                            <h5 class='title my-10'><a ><?= $row['catAR'] ." - ". $row['subCatAR']  ?></a>  </h5>
                                            <div class='media-body'>
                                                <div class='product-desc'>
                                                    <div class='star-rating'>
                                                    <?php for($i=0; $i<=$row['rat']; $i++){
                                                      echo "<span class='ion-ios-star'></span>";
                                                    }?>
                                                        
                                               </div>
                                                    <h3 class='title my-10'><a ><?= $row['proNameAR'] ?></a>  </h3>
                                                            <h3 class='title my-10'><a
                                                                ><?= $row['storeNameAR'] ?> <img  width='50px' src="assets/img/<?= $row['storeLogo'] ?>"> </a></h3>
                                                    <h6 class='product-price'><del class='del'><?= $row['oldPri'] ?></del>


                                                        <span class='onsale'><?= $row['newPri']?></span></h6>
                                                        ...
                                                        <!--////Price --><input type="hidden" name="price" value="<?= $row['newPri'] ?>">
                                                        <!--////ProName --><input type="hidden" name="img" value="<?= $row['img'] ?>">
                                                        <!--////StoreName --><input type="hidden" name="state" value="<?= $row['stockAR'] ?>">
                                                        ...
                                                        <!--////StoreName --><input type="hidden" name="color" value="<?= $row['colorAR'] ?>">
                                                        <!--////StoreName --><input type="hidden" name="dis" value="<?= $row['disAR'] ?>">
        ...
        <div class="row" >
            <div class="col-12">
                <div class="tab-content" id="pills-tabContent">
                    <h2 class="title text-dark text-capitalize mb-20" style="text-align: right;">افضل البائعين</h2>
                    <!-- first tab-pane -->
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        aria-labelledby="pills-home-tab">
                        <div class="product-slider-init theme1 slick-nav">
                          <?php 
                          include ("linkToDB.php");
                          $select = mysqli_query($conn, "select * from topSel");
                          while($row = mysqli_fetch_assoc($select)){
                     ?>
                    <form id="ts" method="post" action="index.php?id=<?= $row['id'] ?>">
                     <div class='slider-item'>
                                <div class='card product-card'>
                                    <div class='card-body p-0'>
                                        <div class='media flex-column'>
        ...
        <div class="row" >
            <div class="col-12">
                <div class="tab-content" id="pills-tabContent">
                    <h2 class="title text-dark text-capitalize mb-20">الخصومات</h2>
                    <!-- first tab-pane -->
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        aria-labelledby="pills-home-tab">
                        <div class="product-slider-init theme1 slick-nav">
                          <?php 
                          include ("linkToDB.php");
                          $select = mysqli_query($conn, "select * from dispro");
                          while($row = mysqli_fetch_assoc($select)){
                     ?>
                    <form id="ac" method="post" action="index.php?id=<?= $row['id'] ?>">
                     <div class='slider-item'>
                                <div class='card product-card'>
                                    <div class='card-body p-0'>
                                        <div class='media flex-column'>
                  ...
                  while($row = mysqli_fetch_assoc($select)){
                    echo "<div class='slider-item'>
                        <div class='testimonial-content text-center'>
                            <img class='mb-30 mx-auto' src='assets/img/$row[img]' alt='user'>
                            <p> $row[feedback] </p>
                            <span class='ion-quote mt-15 mb-30'></span>
                            <h4 class='text-uppercase mb-15'>$row[name]</h4>
                            <a class='text-capitalize' href='mailto:$row[email]'>$row[email]</a>
                        </div>
                    </div>";
                  }
                  ?>
