    ...
    <div class="row">
      <div class="col-12">
        <div class="breadcrumb-title text-center my-20">
          <h2 class="title text-dark text-capitalize">المتاجر المفضلة</h2>
        </div>
      </div>
      <div class="col-12">
        <ol
...
<section class="whish-list-section theme1 pb-70">
    <div class="container grid-wraper">
        <div class="row">
            <div class="col-12">
                <h3 class="title pb-30 text-center text-md-left text-capitalize" style="float: right;">المتاجر المفضلة</h3><br><br>
                <div class="table-responsive">
                    <table class="table mb-0">
                        <thead class="thead-light">
                            <tr>
                                <th class="text-center" scope="col">المنتجات</th>
                                <th class="text-center" scope="col">اسم المتجر</th>
                                
                                <th class="text-center" scope="col">شعار المتجر</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php 
                            ...
                            while($row = mysqli_fetch_assoc($data2)){
                             if($row['type'] == "favorite"){
                                         ...
                                         <td class='text-center' scope='row'>
                                           <a href='#' class='btn theme-btn--dark1 btn--xl text-uppercase'>عرض</a>
                                           </td>
                                           <td class='text-center' scope='row'>
                                           $row[storeName]
                                           </td>
                                           ...
                                           <td class='text-center' scope='row'>
                                           <img src='assets/img/$row[storeLogo]' width='100px' alt='img'>
                                           </td>
                                           </tr>";
                                         }}
                            ?>
