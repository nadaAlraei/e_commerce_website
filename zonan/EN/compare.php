    ...
    <div class="row">
      <div class="col-12">
        <div class="breadcrumb-title text-center my-20">
          <h2 class="title text-dark text-capitalize">wish list</h2>
        </div>
      </div>
      <div class="col-12">
        <ol
...
<section class="compare-section theme1 pb-70">
    <div class="container grid-wraper">
        <div class="row">
            <div class="col-12">
                <h3 class="title pb-25 text-center text-md-left text-capitalize">wish list</h3>
                             ...
                             if($row['type'] == "wish"){
                                    ...
                                    <form method="post" action="compare.php?id=<?= $row['proID'] ?>">
                                      <!--////ProName --><input type="hidden" name="proName" value="<?= $row['proName'] ?>">
                                                        ...
                                                        <button name="add_to_cart"><a class='btn  theme-btn--dark1 btn--xl'> Add To Cart</a></button>
                                  </form>
                               <?php "</th> ";
                                         }}
                            ?>
