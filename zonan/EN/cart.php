                    ...
                    <table class="table mb-0">
                        ...
                        <?php 
                            ...
                            <form method="post" action="checkout.php?id=<?= $row['uid'] ?>">
                                    <div class='product-count style'><label style="font-size: 8px; color:gray">Enter 1 -10</label><br>
                           ...
                           <input type="submit" name="buy" value="Buy Now" class='btn theme-btn--dark1 btn--xl text-uppercase'></td></form> 
                                     </tr>
                                   <?php  
...
<section class="whish-list-section theme1 pb-70">
  <div class="container grid-wraper">
      <div class="row">
          <div class="col-12">
              <h3 class="title pb-25 text-center text-md-left text-capitalize">Your Orders</h3>
              <div class="table-responsive">
                  <table class="table mb-0">
                      <thead class="thead-light">
                          <tr>
