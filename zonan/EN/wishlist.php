    ...
    <div class="row">
      <div class="col-12">
        <div class="breadcrumb-title text-center my-20">
          <h2 class="title text-dark text-capitalize">Favorite Shop</h2>
        </div>
      </div>
      <div class="col-12">
        <ol
...
<section class="whish-list-section theme1 pb-70">
    <div class="container grid-wraper">
        <div class="row">
            <div class="col-12">
                <h3 class="title pb-30 text-center text-md-left text-capitalize">Favorite Shop</h3>
                <div class="table-responsive">
                    <table class="table mb-0">
                        <thead class="thead-light">
                            <tr>
                                <th class="text-center" scope="col">Shop Logo</th>
                                <th class="text-center" scope="col">Shop Name</th>
                                <th class="text-center" scope="col">View Products</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php 
                            ...
                            while($row = mysqli_fetch_assoc($data2)){
                             if($row['type'] == "favorite"){
                                         ...
                                         <td class='text-center' scope='row'>
                                           ...
                                           <td class='text-center' scope='row'>
                                           <a href='#' class='btn theme-btn--dark1 btn--xl text-uppercase'>View</a>
                                           </td>
