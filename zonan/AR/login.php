...
<div id="offcanvas-wishlist" class="offcanvas offcanvas-wishlist theme1">
  <div class="inner">
    ...
    <ul class="minicart-product-list">
      <li>
        <a href="" class="image"
          ><img src="assets/img/product/4.jpg" alt="Cart product Image"
        /></a>
        <div class="content">
      ...
      <li>
        <a href="" class="image"
          ><img src="assets/img/product/5.jpg" alt="Cart product Image"
        /></a>
        <div class="content">
      ...
      <li>
        <a href="" class="image"
          ><img src="assets/img/product/6.jpg" alt="Cart product Image"
        /></a>
        <div class="content">
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart theme1">
  <div class="inner">
    ...
    <ul class="minicart-product-list">
      <li>
        <a href="" class="image"
          ><img src="assets/img/product/1.jpg" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="" class="title">Walnut Cutting Board</a>
          <span class="quantity-price"
            >1 x <span class="amount">$100.00</span></span>
            <span class="quantity-price"
            >Store Logo <span class="amount">Store Name</span></span>
      ...
      <li>
        <a href="" class="image"
          ><img src="assets/img/product/2.jpg" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="" class="title">Lucky Wooden Elephant</a>
          <span class="quantity-price"
      ...
      <li>
        <a href="" class="image"
          ><img src="assets/img/product/3.jpg" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="" class="title">Fish Cut Out Set</a>
          <span class="quantity-price"
    ...
    <div class="row">
      <div class="col-12">
        <div class="breadcrumb-title text-center my-20">
          <h2 class="title text-dark text-capitalize">تسجيل الدخول</h2>
        </div>
      </div>
      <div class="col-12">
...
<!-- product tab start -->
<div class="my-account pb-70" style="text-align: right;">
    <div class="container grid-wraper">
        <div class="row">
            <div class="col-12">
                <h3 class="title text-capitalize pb-30" > سجل الدخول الى حسابك</h3>
                <form method="post" action="logVal.php" class="log-in-form" >
                    <div class="form-group row">
                        <label for="staticEmail" class=" col-form-label">اسم المستخدم / رقم الهاتف</label>
                        <div>
                    ...
                    <div class="form-group row">
                       <label for="inputPassword" class="col-form-label">كلمة السر 
                        <div >
                    ...
                    <div class="form-group row pb-3 text-center">
                        <div class="col-md-6 offset-md-3">
                            <div class="login-form-links">
                                <a href="#" class="for-get">نسيت كلمة السر</a>
                    ...
                    <div class="form-group row">
                            <div class="col-12">
                                <div class="sign-btn text-center">
                                    <input type="submit" name="add" value="سجل الدخول" class="btn theme-btn--dark1 btn--md">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row pb-3 text-center">
                      <div class="col-md-6 offset-md-3">
                          <div class="login-form-links">
                              <span class="for-get">سجل الدخول عن طريق حساب الفيسبوك</span>
                              <div class="sign-btn">
                  ...
                  <div class="form-group row text-center mb-0">
                        <div class="col-12">
                            <div class="border-top">
                                <a href="register.php" class="no-account">انشاء الحساب</a>
                            </div>
                        </div>
                    </div>
            </div>
