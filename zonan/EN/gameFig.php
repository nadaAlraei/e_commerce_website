        ...
        <div class="row">
            ...
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Gamming (Figurines)</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container grid-wraper">
        <div class="grid-nav-wraper mb-30">
          ...
          while($row = mysqli_fetch_assoc($data)){
             ...
             $id = $row['id'];
             $str = "store" . $id;
             $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Gamming' AND subCat = 'Figurines')");
        ...
        <div class="tab-content" id="pills-tabContent">
          ...
          while($row = mysqli_fetch_assoc($data)){
             ...
             if(isset($_POST['low_to_highR'])){
              ...
              $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Gamming' AND subCat = 'Figurines') ORDER BY rat ASC");
              }
              else if(isset($_POST['high_to_lowR'])){
              
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Gamming' AND subCat = 'Figurines') ORDER BY rat DESC");
              }
              else if(isset($_POST['low_to_highP'])){
              
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Gamming' AND subCat = 'Figurines') ORDER BY Price ASC");
              }
              else if(isset($_POST['high_to_lowP'])){
              
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Gamming' AND subCat = 'Figurines') ORDER BY Price DESC");
              }
              else{
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Gamming' AND subCat = 'Figurines')");
              }
                        ...
                        <div class='card product-card'>
                            <div class='card-body p-0'>
                                <div class='product-thumbnail position-relative'>
                                    ...
                                    <!-- product links -->
                                    <form  method="post" action="gameFig.php?id=<?= $row['id'] ?>">
