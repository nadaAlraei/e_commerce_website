        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-title text-center my-20">
                    <h2 class="title text-dark text-capitalize">Accessories</h2>
                </div>
            </div>
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Accessories (Hand Made)</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container grid-wraper">
        <div class="grid-nav-wraper mb-30">
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-0">
                    <nav class="shop-grid-nav">
                        <ul class="nav nav-pills align-items-center" id="pills-tab" role="tablist">
                            ...
                            <li> <span class="total-products text-capitalize">There are
                            <?php 
          ...
          while($row = mysqli_fetch_assoc($data)){
             ...
             $id = $row['id'];
             $str = "store" . $id;
             $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Accessories' AND subCat = 'Hand Made')");
                ...
                <div class="col-12 col-md-6 position-relative">
                    <div class="shop-grid-button d-flex align-items-center">
                        ...
                        <div class="dropdown-menu shop-grid-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="index.php #shop"> Sub Categories</a>
                            <form action="" method="post">
                            <input name="low_to_highR" type="submit"  class="dropdown-item" value="Rate, low to high"> 
                            <input name="high_to_lowR" type="submit"  class="dropdown-item" value="Rate, high to low">
                            <input name="low_to_highP" type="submit"  class="dropdown-item" value="Price, low to high">
                            <input name="high_to_lowP" type="submit"  class="dropdown-item" value="Price, high to low">
                          </form>
                            <a class="dropdown-item" href="index.php #bs"> Products View</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="row grid-view theme1">
                  <h2 class="title text-dark text-capitalize mb-20">All</h2>
                  <?php 
          ...
          while($row = mysqli_fetch_assoc($data)){
             ...
             if(isset($_POST['low_to_highR'])){
              ...
              $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Accessories' AND subCat = 'Hand Made') ORDER BY rat ASC");
              }
              else if(isset($_POST['high_to_lowR'])){
              
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Accessories' AND subCat = 'Hand Made') ORDER BY rat DESC");
              }
              else if(isset($_POST['low_to_highP'])){
              
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Accessories' AND subCat = 'Hand Made') ORDER BY Price ASC");
              }
              else if(isset($_POST['high_to_lowP'])){
              
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Accessories' AND subCat = 'Hand Made') ORDER BY Price DESC");
              }
              else{
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE (cat = 'Accessories' AND subCat = 'Hand Made')");
              }
                        ...
                        <div class='card product-card'>
                            <div class='card-body p-0'>
                                <div class='product-thumbnail position-relative'>
                                    ...
                                    <!-- product links -->
                                    <form  method="post" action="accessHand.php?id=<?= $row['id'] ?>">
                  ...
                  <div class='product-desc'>
                                    <h3 class='title'><a> <?php echo $row['proName']?></a></h3>
                                                <h3 class='title'><a><?php echo $row['storeName']?> </a></h3>
             ...
             <!--////StoreName --><input type="hidden" name="dis" value="<?= $row['fullDis'] ?>">
...
<button name="add_to_wish"><li><a>
    ...
    <!-- product links end-->
                                    ...
                                    <div class='media-body pl-sm-4 mt-30 mt-sm-0'>
                                        <div class='product-desc'>
                                            <h3 class='title'><a href=''><?php echo $row['proName']?></a></h3>
                                                    <h3 class='title'><?php echo $row['storeName']?> <img src='assets/img/<?php echo $row['storeLogo']?>' width='50px'></h3>
                                        ...
                                        <div class='availability-list pb-30 mt-20 border-bottom'>
                                            <p>Availability: <span><?php echo $row['stock']?></span></p>
                                        </div>
                                        <ul class='product-list-des'>
                                            <li>
                                              <?php echo $row['shortDis']?>
                                            </li>
                                            <li>
                                            <?php echo $row['fullDis']?>
                                            </li>
