        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-title text-center my-20">
                    <h2 class="title text-dark text-capitalize">الاسئلة و الاجوبة</h2>
                </div>
            </div>
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    
                    <li class="breadcrumb-item active" aria-current="page">الاسئلة و الاجوبة</li>
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="row grid-view theme1">
                    <div class="col-sm-6 col-md-4 mb-30"style="width: 100%; text-align:right">

                    <?php 
                    include ("linkToDB.php");
                    $select = mysqli_query($conn, "select * from fqa");
                    while ( $row = mysqli_fetch_assoc($select)){
                      echo "<div class='card product-card' >
                                <div class='product-desc'>
                                    <h3 class='title' style='cursor: pointer; font-size: 20px;'><a onclick='showAnsw()'> س : $row[qusAR] ؟ </a></h3>
                                    <h3 class='title' id='ans' >$row[ansAR]</h3>
                                </div>
                         </div>";
                    }
                    ?>
...
<!-- modals end -->
     ...
     ******************************************************-->
     <script>
      ...
      function showAnsw(){
        var popup = document.getElementById("ans");
        var popup2 = document.getElementById("ans2");
        var popup3 = document.getElementById("ans3");

        popup.classList.toggle("showAns");
        popup2.classList.remove("showAns");
        popup3.classList.remove("showAns");
      }
      ...
      function showAnsw2(){
        ...
        popup.classList.remove("showAns");
        popup2.classList.toggle("showAns");
        popup3.classList.remove("showAns");
      }
      ...
      function showAnsw3(){
        ...
        popup.classList.remove("showAns");
        popup2.classList.remove("showAns");
        popup3.classList.toggle("showAns");
      }
