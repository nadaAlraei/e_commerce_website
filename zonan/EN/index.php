            ...
            echo "<div class='col-md-6 mb-30'>
                <div class='position-relative zoom-in overflow-hidden'>
                    ...
                    <div class='banner-content'>
                        <p class='text text-capitalize text-dark mb-10'>$row[title]</p>
                        <h4 class='title text-capitalize text-dark'>$row[value]</h4>
                        <a class='view-link text-capitalize mt-20' href='$row[link]'>View
                            collection 
...
<section class="product-tab bg-white pt-40 pb-70">
    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="section-title text-center mb-30">
                        <h2 class="title text-dark text-capitalize mb-20" id="bs">Best Sellers</h2>
                        ...
                        <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-home-tab"  href="#hc"
                                    role="tab"  aria-selected="true">Hot Categories</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" href="#ts"
                                    role="tab" aria-selected="false">Top Seller</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-contact-tab" href="#ac"
                                    role="tab" aria-selected="false">Discount Products</a>
                            </li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="row" >
            <div class="col-12">
                <div class="tab-content" id="pills-tabContent">
                    <h2 class="title text-dark text-capitalize mb-20">Hot Categories</h2>
                    <!-- first tab-pane -->
                                    ...
                                    <div class='card-body p-0'>
                                        <div class='media flex-column'>
                                            <div class='product-thumbnail w-100 position-relative'>
                                                ...
                                                <!--////Add btn --><input type="submit" name="add_to_cart" class="btn  btn-block" value="Add To Cart"> 
                                            ...
                                            <h5 class='title my-10'><a ><?= $row['cat'] ." - ". $row['subCat']  ?></a>  </h5>
                                            <div class='media-body'>
                                                <div class='product-desc'>
                                                    ...
                                                    <h3 class='title my-10'><a ><?= $row['proName'] ?></a>  </h3>
                                                            <h3 class='title my-10'><a
                                                                ><?= $row['storeName'] ?> <img  width='50px' src="assets/img/<?= $row['storeLogo'] ?>"> </a></h3>
        ...
        <div class="row" >
            <div class="col-12">
                <div class="tab-content" id="pills-tabContent">
                    <h2 class="title text-dark text-capitalize mb-20">Top Seller</h2>
                    <!-- first tab-pane -->
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        aria-labelledby="pills-home-tab">
                        <div class="product-slider-init theme1 slick-nav">
                                        ...
                                        <div class='media flex-column'>
                                            ...
                                            <div class='media-body'>
                                                <div class='product-desc'>
                                                    ...
                                                    <h3 class='title my-10'><a ><?= $row['proName'] ?></a></h3>
                                                            <h3 class='title my-10'><a
                                                                ><?= $row['storeName'] ?> <img name='storeImg' width='50px' src="assets/img/<?= $row['storeLogo'] ?>"> </a></h3>
                                                    <h6 class='product-price'><del class='del'><?= $row['oldPri'] ?></del>
        ...
        <div class="row" >
            <div class="col-12">
                <div class="tab-content" id="pills-tabContent">
                    <h2 class="title text-dark text-capitalize mb-20">Discount Products</h2>
                    <!-- first tab-pane -->
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        aria-labelledby="pills-home-tab">
                        <div class="product-slider-init theme1 slick-nav">
                                    ...
                                    <div class='card-body p-0'>
                                        <div class='media flex-column'>
                                            <div class='product-thumbnail w-100 position-relative'>
                                                ...
                                                <input type="submit" name="add_to_cart" class="btn btn-block" value="Add To Cart"> 
...
<div class="overlay">
    ...
    <div>
      ...
      <button name="search" id="close" type="submit" style="margin-top: 2%;">
        <i class="ion-ios-search-strong"></i>
      </button>
    </div>
