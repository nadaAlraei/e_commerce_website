    ...
    <div class="row">
      <div class="col-12">
        <div class="breadcrumb-title text-center my-20">
          <h2 class="title text-dark text-capitalize">اتمام الطلب</h2>
        </div>
      </div>
      <div class="col-12">
        <ol
...
<!-- product tab start -->
<section class="check-out-section pb-40" style="text-align: right;">
                ...
                <div id="accordion">
                   ...
                   ?>
                                    <div class="form-group row">
                                        ...
                                        <label for="firstname" class="col-md-3 col-form-label">الاسم الاول</label>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <label for="lastname" class="col-md-3 col-form-label">الاسم الاخير</label>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <label for="email" class="col-md-3 col-form-label">رقم الهاتف</label>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <label for="email" class="col-md-3 col-form-label">العنوان</label>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="check-box-inner pt-0">
                                                <div class="filter-check-box">
                                                    ...
                                                    <label for="20820">تلقي العروض من شركائنا</label>
                                                    
                                                </div>
                                                
                                                <div class="filter-check-box">
                                                    <input type="checkbox" id="20821" required>
                                                    <label for="20821">سجل للحصول على اخر اخبارنا</label>
                                                    <p class="pl-25">كن أول من يعرف. اشتراك في
                                                         النشرة الإخبارية
                                                         اليوم !</p>
                          ...
                          <input type="hidden" name="qty" value="<?= $orderInfo['qty'] ?>">                             
                                        ...
                                        <div class="col-12">
                                            <div class="sign-btn text-left">
                                                <input type="submit" name="add_info" value="التالي" class="btn theme-btn--dark1 btn--md">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="card-body">
                                <div class="checkout-inner border-0">
                                    <div class="checkout-address p-0">
                                        <p>
                                        سيتم استخدام العنوان المحدد كعنوانك الشخصي (للفاتورة) وكعنوان التسليم الخاص بك
                                        </p>
                                    </div>
                   ...
                   ?>
                                           <div class="form-group row">
                                              ...
                                              <label class="col-md-3" for="city">اختر العنوان</label>
                                          </div> 
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-3">المقاطعات</label>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <label class="col-md-3" for="city">المنطقة</label>
                                          </div>
                                          <div class="form-group row">
                                            ...
                                            <label class="col-md-3" for="city">الشارع</label>
                                        </div>
                                        <div class="form-group row">
                                          ...
                                          <label class="col-md-3" for="city">رقم العمارة</label>
                                      </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-9 col-md-offset-3">
                                                    <div class="filter-check-box mb-0">
                                                        ...
                                                        <label class="checkout" for="20824">اتمام الطلب</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-0">
                                                <div class="col-12 text-left">
                                                    <input value="التالي"  name="more_info" type="submit"
                   ...
                   ?>
                                      <div class="form-group row">
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <input class="form-control" style="margin-bottom: 5px;" placeholder="<?php echo $orderInfo2['card'] ?>" id="firstName2" name="number"
                                              ...
                                              <div id="paypal-button"></div><label style="color: gray; font-size: 10px;">أنواع بطاقات الائتمان والخصم المقبولة</label>
                                          </div>
                                          <label class="col-md-3" for="firstName2">رقم البطاقة</label>
                                      </div>
                                      <div class="form-group row">
                                          
                                          <div class="col-md-6" >
                                              <label>السنة </label> <label style="margin-left: 25px;"> الشهر</label>
                                              ...
                                              <input  placeholder="<?php echo $orderInfo2['cardM'] ?>" id="lastName2" name="month"
                                                  ...
                                                  <label style="color: gray; font-size: 10px;">مثل 10\22</label>
                                          </div>
                                          <label class="col-md-3" for="lastName2">تاريخ الانتهاء</label>
                                      </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <label class="col-md-3" for="city">اسم البطاقة</label>
                                    </div>
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-6">
                                          <input class="form-control" maxlength="3" id="street" placeholder="<?php echo $orderInfo2['cardSec'] ?>" name="sCard" type="text"
                                              required="">
                                          <label style="color: gray; font-size: 10px;">آخر 3 أرقام على ظهر البطاقة</label>
                                      </div>
                                      <label class="col-md-3" for="city">رمز الامن</label>
                                  </div>
                                 
                                      <div class="form-group row mb-0">
                                          <div class="col-12 text-left">
                                              <button name="add_card" type="submit"
                                                  class="btn theme-btn--dark1 btn--md">التالي</button>
                                          </div>
                                      </div>
                                  </form>
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                            <div class="card-body pt-0">
                                <div class="custom-radio mb-4">
                                    <label for="test5">السعر النهائي</label>
                                </div>
                                
                                <form method="post">
                                <div class="filter-check-box mb-4">
                                    <input type="checkbox" id="20828" required="">
                                    <label class="checkout" for="20828">أوافق على الشروط</label>
                                </div>
                                <input value="تم" name="done" type="submit"
                                  class="btn theme-btn--dark1 btn--md" style="float:left"><br><br>
                                </form>
...
echo $sum3  . " JD";
      ?></li>
                        ...
                        <ul class="items">
                            <li>المجموع (غير شامل الضريبة)</li>
                            <li>الضريبة</li>
                        </ul>
                    ...
                    <li class="list-group-item text-center">
                        ...
                        <input type="submit" value="اتمام العملية" name="check" class="btn theme-btn--dark1 btn--md">
                ...
                <div class="delivery-info mt-20">
                    <ul>
                        <li>
                            سياسة الأمان (قم بتحريرها باستخدام وحدة طمأنة العميل) <img src="assets/img/icon/10.png" alt="icon">
                        </li>
                        <li>
                            سياسة التوصيل (قم بتحريرها باستخدام وحدة طمأنة العميل) <img src="assets/img/icon/11.png" alt="icon">
                        </li>
                        <li class="mb-0">
                             سياسة الإرجاع (قم بتحريرها باستخدام وحدة طمأنة العميل) <img src="assets/img/icon/12.png" alt="icon">
                        </li>
                    </ul>
                </div>
            </div>
