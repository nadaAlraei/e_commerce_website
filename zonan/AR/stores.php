        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-title text-center my-20">
                    <h2 class="title text-dark text-capitalize">المتاجر</h2>
                </div>
            </div>
            <div class="col-12">
    ...
    <div class="container grid-wraper">
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                ...
                while($row = mysqli_fetch_assoc($data)){
                  echo "<div class='col-sm-6 col-md-4 mb-30'>
                        <div class='card product-card'>
                            <div class='card-body p-0'>
                                <div class='product-thumbnail position-relative'>
                                    <a>
                                        <img class='first-img' src='assets/img/$row[storeLogo]' alt='thumbnail'>
                                    </a>
                                </div>
                                <div class='product-desc' style='text-align:center;'>
                                    <h3 class='title'><a href=''>اسم المتجر: $row[storeNameAR]</a></h3>
                                    <h3 class='title'><a href=''>عدد المنتجات: ";
                                    $coun = mysqli_num_rows($data);
