        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-title text-center my-20">
                    <h2 class="title text-dark text-capitalize">الالعاب</h2>
                </div>
            </div>
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    
                    <li class="breadcrumb-item active" aria-current="page">الالعاب (التماثيل)</li>
                    <li class="breadcrumb-item"><a href="index.php">الصفحة الررئيسية</a></li>
                </ol>
            </div>
        </div>
    </div>
