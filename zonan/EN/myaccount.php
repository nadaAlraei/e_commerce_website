...
$str = "User" . $id;
   ...
   $order = mysqli_query($conn,"SELECT * FROM $str  WHERE type='order2'");
                        ...
                        <div class="myaccount-content">
                            ...
                            <div class="account-details-form">
                                ...
                                if(isset($_POST['update'])){
                                  $data = mysqli_query($conn, "SELECT * FROM users WHERE id='$_SESSION[id]'");
                                  while ($row = mysqli_fetch_assoc($data)){
                                    if($_POST['mypass'] == $row['pass']){
                                      if($_POST['pass'] == $_POST['pass2']){
                                        $update = mysqli_query($conn, "UPDATE users SET fName='$_POST[fn]',lName='$_POST[ln]',username='$_POST[user]',addr='$_POST[pro]',phone='$_POST[phone]',pass='$_POST[pass]' WHERE id='$_SESSION[id]'");
                                      }
                                    }
                                  }
                                }
                                ...
                                ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12 mb-30">
                                            ...
                                            <input id="first-name" name="fn" placeholder="First Name" type="text" required>
                                        </div>

                                        <div class="col-lg-6 col-12 mb-30">
                                            <input id="last-name" name="ln" placeholder="Last Name" type="text" required>
                                        </div>

                                        <div class="col-12 mb-30">
                                            <input id="display-name" name="user" placeholder="Username" type="text" required>
                                        </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-12 mb-30">
                                            <select class="input-group-prepend" name="pro" required>
                                        ...
                                        <div class="col-12 mb-30">
                                            <input id="current-pwd" name="mypass" placeholder="Current Password" type="password" required>
                                        </div>

                                        <div class="col-lg-6 col-12 mb-30">
                                            <input id="new-pwd" name="pass" placeholder="New Password" type="password" required>
                                        </div>

                                        <div class="col-lg-6 col-12 mb-30">
                                            <input id="confirm-pwd" name="pass2" placeholder="Confirm Password" type="password" required>
                                        </div>

                                        <div class="col-12">
                                            <input type="submit" name="update" class="btn theme-btn--dark1 btn--md" value="Save Changes">
                                        </div>
