        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-title text-center my-20">
                    <h2 class="title text-dark text-capitalize">الامان</h2>
                </div>
            </div>
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    
                    <li class="breadcrumb-item active" aria-current="page">الامان</li>
                    ...
                    <div class="col-sm-6 col-md-4 mb-30"style="width: 100%;">
                        ...
                        <div class="card product-card" >
                                <div class="product-desc">
                                    <h3 class="title" style="cursor: pointer; font-size: 20px; text-align:right;">
                                        <?php 
                                        include ("linkToDB.php");
                                        $select = mysqli_query($conn, "select * from sec");
                                        $row = mysqli_fetch_assoc($select);
                                        echo $row['titleAR'];
                                        ?>
                                    </h3><br>
