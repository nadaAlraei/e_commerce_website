    ...
    <div class="row">
      <div class="col-12">
        <div class="breadcrumb-title text-center my-20">
          <h2 class="title text-dark text-capitalize">Sign up</h2>
        </div>
      </div>
      <div class="col-12">
        ...
        <div class="row">
            <div class="col-12">
                ...
                ?>">
                        ...
                        <div class="form-group row">
                            <label for="firstname" class="col-md-3 col-form-label">last
                                name </label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="lastname" class="col-md-3 col-form-label">Username</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <div class="sign-btn text-right">
                                    <input type="submit" name="add" value="SignUp" class="btn theme-btn--dark1 btn--md">
                                </div>
                            </div>
                        </div>
                    </form>
