            ...
            echo "<div class='col-md-6 mb-30'>
                <div class='position-relative zoom-in overflow-hidden'>
                    ...
                    <div class='banner-content' style='float:right; text-align:right; margin-left:65%' >
                        ...
                        <a class='view-link text-capitalize mt-20' href='login.php'><span class='ion-android-arrow-dropleft-circle theme-color'></span> عرض المجموعة
                            </a>
                    </div>
                </div>
            </div>";
            ...
            <div class="col-12">
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active"  id="pills-home" role="tabpanel"
                     ...
                     ?>
                    <form id="hc" method="post" action="login.php">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <div class="product-slider-init theme1 slick-nav">
                          ...
                          while($row = mysqli_fetch_assoc($select)){
                     ?>
                    <form id="ts" method="post" action="login.php">
                     <div class='slider-item'>
                                <div class='card product-card'>
                                    <div class='card-body p-0'>
                                        <div class='media flex-column'>
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <div class="product-slider-init theme1 slick-nav">
                          ...
                          while($row = mysqli_fetch_assoc($select)){
                     ?>
                    <form id="ac" method="post" action="login.php">
                     <div class='slider-item'>
                                <div class='card product-card'>
                                    <div class='card-body p-0'>
                                        <div class='media flex-column'>
