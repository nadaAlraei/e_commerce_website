        ...
        <div class="row">
            ...
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Bages (All)</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container grid-wraper">
        <div class="grid-nav-wraper mb-30">
          ...
          while($row = mysqli_fetch_assoc($data)){
             ...
             $id = $row['id'];
             $str = "store" . $id;
             $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE cat = 'Bages'");
        ...
        <div class="tab-content" id="pills-tabContent">
          ...
          while($row = mysqli_fetch_assoc($data)){
             ...
             if(isset($_POST['low_to_highR'])){
              ...
              $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE cat = 'Bages' ORDER BY rat ASC");
              }
              else if(isset($_POST['high_to_lowR'])){
              
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE cat = 'Bages' ORDER BY rat DESC");
              }
              else if(isset($_POST['low_to_highP'])){
              
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE cat = 'Bages' ORDER BY Price ASC");
              }
              else if(isset($_POST['high_to_lowP'])){
              
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE cat = 'Bages' ORDER BY Price DESC");
              }
              else{
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE cat = 'Bages'");
              }
          ...
          while($row = mysqli_fetch_assoc($data)){
             ...
             if(isset($_POST['low_to_highR'])){
              ...
              $data2 = mysqli_query($conn,"SELECT * FROM $str WHERE cat = 'Bages' ORDER BY rat ASC");
               ...
               $data2 = mysqli_query($conn,"SELECT * FROM $str WHEREcat = 'Bages'");
              }
                while($row = mysqli_fetch_assoc($data2)){?>
                <form method="post" action="bags.php?id=<?= $row['id'] ?>">
...
<button name="add_to_wish"><li><a>
    ...
    <!-- product links end-->
                                    ...
                                    <div class='media-body pl-sm-4 mt-30 mt-sm-0'>
                                        <div class='product-desc'>
                                            <h3 class='title'><?php echo $row['proName']?></a></h3>
                                                    <h3 class='title'><a href=''><?php echo $row['storeName']?> <img src='assets/img/<?php echo $row['storeLogo']?>' width='50px'></h3>
