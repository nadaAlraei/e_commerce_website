        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-title text-center my-20">
                    <h2 class="title text-dark text-capitalize">FAQ</h2>
                </div>
            </div>
            <div class="col-12">
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="row grid-view theme1">
                    <div class="col-sm-6 col-md-4 mb-30"style="width: 100%;">
                    ...
                    while ( $row = mysqli_fetch_assoc($select)){
                      echo "<div class='card product-card' >
                                <div class='product-desc'>
                                    <h3 class='title' style='cursor: pointer; font-size: 20px;'><a onclick='showAnsw()'>Q : $row[qus] ? </a></h3>
                                    <h3 class='title2' id='ans' >$row[ans]</h3>
                                </div>
                         </div>";
                    }
                    ?>
