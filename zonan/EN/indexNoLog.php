            ...
            echo "<div class='col-md-6 mb-30'>
                <div class='position-relative zoom-in overflow-hidden'>
                    ...
                    <div class='banner-content'>
                        ...
                        <a class='view-link text-capitalize mt-20' href='login.php'>View
                            collection 
                                    ...
                                    <div class='card-body p-0'>
                                        <div class='media flex-column'>
                                            <div class='product-thumbnail w-100 position-relative'>
                                                ...
                                                <a class='d-block'>
                                                    <img class='first-img' style='width:360px; height:480px' src='assets/img/$row[img]'
                                                        alt='thumbnail'>
                                                ...
                                                <div class='product-links d-flex d-flex justify-content-between'>
                                                    <a href='login.php' class='pro-btn' >Add to cart</a>
